import createValCommonScript from "./common.js"
import createValProcessScript from "./process.js"
...
export default async function(pnsConfig, vmMoniker, pocketCoreBranch, genesisURL, passphrase, processes) {
    ...
    for (let index = 0; index < processes.length; index++) {
        ...
        const processScript = createValProcessScript(process, genesisURL, passphrase)
        processScripts.push(processScript)
    }

    // Create common script
    const commonScript = createValCommonScript(pocketCoreBranch, processScripts)
