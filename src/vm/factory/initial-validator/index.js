import createInitValCommonScript from "./common.js"
import createInitValProcessScript from "./process.js"
...
export default async function(pnsConfig, vmMoniker, pocketCoreBranch, genesisURL, passphrase, processes) {
    ...
    for (let index = 0; index < processes.length; index++) {
        ...
        const processScript = createInitValProcessScript(process, genesisURL, passphrase)
        processScripts.push(processScript)
    }

    // Create common script
    const commonScript = createInitValCommonScript(pocketCoreBranch, processScripts, pnsConfig.pnsTemplate.initialValidators.ulimit)
